...
class Vote(models.Model):
    ...
    * Vote has choice reference
    ...
    user = models.ForeignKey(User, verbose_name='Voted User', on_delete=models.CASCADE)
    poll = models.ForeignKey(Poll, verbose_name='Voted Poll', on_delete=models.CASCADE)
    choice = models.ForeignKey(Choice, verbose_name='Voted Choice', on_delete=models.CASCADE)
